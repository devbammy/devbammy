    ...
    <section className={styles.hero} id="home">
      ...
      >
        ...
        <motion.p variants={fadeUp}>
          I’m a passionate{' '}
          <span style={highlightStyle}>Front-End Web Developer</span> dedicated
          to creating <span style={highlightStyle}>engaging</span> and visually
          appealing <span style={highlightStyle}>user interfaces</span> that
